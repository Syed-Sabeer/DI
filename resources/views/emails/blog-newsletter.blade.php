        ...
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:560px;">
          <tr>
            <td style="padding:0 0 24px;border-bottom:2px solid #b8e900;">
              <img class="brand" src="{{ $logoUrl }}" width="136" alt="Deveon Inc" style="display:block;width:136px;max-width:100%;height:auto;border:0;">
            </td>
          </tr>
          <tr>
            <td style="padding:28px 0 0;">
              ...
              <p style="margin:24px 0 32px;font-size:15px;line-height:1.7;"><a href="{{ $articleUrl }}" style="color:#315c46;font-weight:700;text-decoration:underline;">Continue reading &rarr;</a></p>

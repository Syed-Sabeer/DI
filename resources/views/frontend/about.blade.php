...
@section('meta_keywords', 'about Deveon Inc, Syed Sabeer Faisal, Deveon founder CEO, software development company
Ottawa, software company Canada, IT company Karachi')
@section('meta_description', 'Meet Deveon Inc — a software company powering intelligent systems for clients in the USA,
Canada, UK and Australia. Founded and led by CEO Syed Sabeer Faisal.')
...
<div class="section aboutme-section">
    <div class="container">
        <div class="row">
            <div class="col-xl-6">
                <div class="chooseus-side-image-container"> <img src="{{ asset('FrontendAssets/images/shapes/45.png')}}"
                        alt="" class="img-fluid" loading="lazy" decoding="async"> <a href="javascript:void(0);"
                        class="choose-play-btn"><i class="ri-play-mini-fill"></i></a> </div>
            </div>
            <div class="col-xl-6">
                <div class="heading-section text-start"> <span
                        class="heading-subtitle rounded-pill border px-3 py-2 d-inline-flex wow fadeInUp mt-4 mt-sm-0"
                        data-wow-delay=".3s"> About Our Agency </span>
                    <h2 class="heading-title mt-4 text-animated-slider custom-about-title"> Highly Tailored <span
                            class="text-primary">IT Solutions</span> Design Management &Services </h2>
                    <p> when an unknown printer took a galley of type and scrambled it to make a type specimen has
                        survived not only five centuries, but also the leap into electronic areayt typesetting emaining
                        essentially. </p>
                </div>
                <div class="profile-content gap-0">
                    <div class="counter-box">
                        <div class="profile-experince-number"> <span class="odometer metricCard__number mb-2"
                                data-count="15"></span> <span class="suffix">+</span> </div>
                        <p class="profile-experince-label">years of experience</p>
                    </div>
                    <div>
                        <ul class="about-feature-list">
                            <li class="feature-list-item"> <span> <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                        ...
                                        <path d="M12.8509 8.18213L8.30543 12.7276L6.23932 10.6615" stroke="#111111"
                                            stroke-width="1.36364" stroke-linecap="round" stroke-linejoin="round">
                                        </path>
                                    </svg> </span> <span class="feature-text"> Close Deals Faster With View </span>
                            </li>
                            <li class="feature-list-item"> <span> <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                        height="20" viewBox="0 0 20 20" fill="none">
                                        <path
...
<section class="section services-section">
    <div class="container">
        <div class="row services-header align-items-end gy-4 mb-5">
            ...
            <div class="col-lg-6">
                <p>
                    From the first line of code to the final launch, we cover every discipline your product needs under
                    one roof.
                </p>
        ...
        <div class="row gy-4 mb-0">
            <div class="col-sm-6 col-lg-4">
                <div class="services-card wow fadeInUp" data-wow-delay=".1s" style="--accent:#f2a90c;">
                    ...
                    <p class="services-card__desc">
                        Custom business software and portal solutions designed for scalability and reliability, built
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="services-card wow fadeInUp" data-wow-delay=".2s" style="--accent:#3b6fe0;">
                    ...
                    <p class="services-card__desc">
                        Deliver seamless and enjoyable digital experiences. Our designs prioritize clarity, ease of use,
                        and attractive interfaces for both web and mobile platforms.
                    </p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="services-card wow fadeInUp" data-wow-delay=".3s" style="--accent:#1f9d63;">
                    ...
                    <p class="services-card__desc">
                        Native and cross-platform app experiences with smooth performance and clean UX. We turn ideas
                        into high-performing mobile apps tailored to your users' needs.
                    </p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="services-card wow fadeInUp" data-wow-delay=".1s" style="--accent:#17a2a6;">
                    ...
                    <p class="services-card__desc">
                        Modern, responsive, and conversion-focused websites tailored to your business goals — from
                        marketing sites to complex web platforms and e-commerce stores.
                    </p>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="services-card wow fadeInUp" data-wow-delay=".2s" style="--accent:#d1483f;">
                    ...
                    <p class="services-card__desc">
                        Search visibility, content strategy, and growth campaigns that drive quality traffic and turn
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="services-card wow fadeInUp" data-wow-delay=".3s" style="--accent:#7b4fd1;">
                    ...
                    <p class="services-card__desc">
                        We build intelligent features — from automation and predictive models to AI-powered integrations
                        — that give your product a competitive edge.
                    </p>
...
<div class="swiper marquee-section about-marquee bg-primary mb-5 page-marquee-section">
    <div class="swiper-wrapper marquee-container">
        <div class="swiper-slide d-flex align-items-center gap-5 marquee-item"> <span class="marquee-text stroke">UI/UX
                Desing</span> <i class="ri-asterisk fs-1 lh-1"></i> </div>
        <div class="swiper-slide d-flex align-items-center gap-5 marquee-item"> <span class="marquee-text">Branding
                Design</span> <i class="ri-asterisk fs-1 lh-1"></i> </div>
        <div class="swiper-slide d-flex align-items-center gap-5 marquee-item"> <span class="marquee-text stroke">10+
                Years Experience</span> <i class="ri-asterisk fs-1 lh-1"></i> </div>
        <div class="swiper-slide d-flex align-items-center gap-5 marquee-item"> <span class="marquee-text">User
                Experience</span> <i class="ri-asterisk fs-1 lh-1"></i> </div>
        <div class="swiper-slide d-flex align-items-center gap-5 marquee-item"> <span
                class="marquee-text stroke">Digital Marketing Strategy</span> <i class="ri-asterisk fs-1 lh-1"></i>
        </div>
        <div class="swiper-slide d-flex align-items-center gap-5 marquee-item"> <span
                class="marquee-text">Professional</span> <i class="ri-asterisk fs-1 lh-1"></i> </div>
        <div class="swiper-slide d-flex align-items-center gap-5 marquee-item"> <span
                class="marquee-text stroke">Digital Marketing</span> <i class="ri-asterisk fs-1 lh-1"></i> </div>
    </div>
</div>
            ...
            <div class="col-xl-5">
                <div class="founder-photo-card">
                    <div class="founder-photo-frame">
                        <img src="{{ asset('FrontendAssets/images/profile/founder.webp')}}"
                            alt="Syed Sabeer Faisal — Founder & CEO of Deveon Inc" class="founder-photo" loading="lazy"
                            decoding="async">
                    ...
                    <ul class="founder-social">
                        <li><a href="{{ config('seo.social.facebook') }}" target="_blank" rel="noopener noreferrer"
                                aria-label="Deveon Inc on Facebook"><i class="ri-facebook-circle-fill"></i></a></li>
                        <li><a href="{{ config('seo.social.x') }}" target="_blank" rel="noopener noreferrer"
                                aria-label="Deveon Inc on X"><i class="ri-twitter-x-line"></i></a></li>
                        <li><a href="{{ config('seo.social.linkedin') }}" target="_blank" rel="noopener noreferrer"
                                aria-label="Deveon Inc on LinkedIn"><i class="ri-linkedin-box-fill"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-7">
                <div class="heading-section text-start mb-4">
                    <span class="heading-subtitle rounded-pill border px-3 py-2 d-inline-flex wow fadeInUp"
                        data-wow-delay=".3s"> <i class="ri-star-fill"></i> Leadership </span>
                    <h2 class="heading-title mt-4 text-animated-slider"> Meet Our <span class="text-primary">Visionary
                            Founder</span> </h2>
                </div>
                <div class="founder-quote">
                    <p>&ldquo;At Deveon Inc, we don't just build software — we craft digital experiences that transform
                        businesses and empower brands to thrive in an ever-evolving digital landscape.&rdquo;</p>
                </div>
                <div class="founder-bio">
                    <p class="op-7 mb-3">
                        Since founding this company, my vision has been clear: to deliver world-class digital solutions
                        that combine cutting-edge technology with strategic creativity. From <strong>custom software
                            development</strong> and <strong>mobile applications</strong> to <strong>graphic
                            design</strong>, <strong>branding</strong>, and <strong>digital marketing</strong> — we
                        bring ideas to life with precision, passion, and purpose.
                    </p>
                    <p class="op-7 mb-4">
                        Our team doesn't just meet expectations — we exceed them. We build lasting partnerships with
                        clients, understanding their unique challenges and delivering solutions that drive real,
                        measurable results.
                    </p>
                </div>
                <div class="row gy-3">

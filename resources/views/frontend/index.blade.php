...
@section('meta_keywords', 'custom software development company, AI automation company, mobile app development company
USA, software development company Canada, app developers UK, software company Australia, ERP CRM development, UI UX
design agency, Deveon Inc')
@section('meta_description', 'Deveon Inc builds custom software, mobile apps, ERP/CRM platforms and AI automation for
businesses in the USA, Canada, UK and Australia. 150+ clients, 5+ years, 4.9/5 rated.')
...
<style>
  ...
  */
  ...
  .home-blog-section .blog-card__media {
    ...
    display: block;
    aspect-ratio: 16 / 10;
    /* house ratio: source images are 1600x1000 */
    overflow: hidden;
    background: var(--gray-100);
  }
  ...
  .dv-proof__avatars li:first-child {
  ...
  @keyframes dvFloat {
    ...
    0%,
    100% {
      transform: rotateY(-15deg) rotateX(6deg) rotateZ(-1deg) translateY(0);
    }

    50% {
      transform: rotateY(-15deg) rotateX(6deg) rotateZ(-1deg) translateY(-12px);
    }
  }
  ...
  .dv-ghost--2 {
    transform: translate3d(19%, -12%, -160px);
    opacity: 0.26;
  }
  ...
  .dv-legend li:nth-child(2) em {
    background: rgba(255, 255, 255, 0.32);
  }

  .dv-legend li:nth-child(3) em {
  ...
  @media (max-width: 575px) {
    ...
    .dv-ui__stats .dv-card:last-child {
      display: none;
    }
                    ...
                    <div class="dv-ui__stats">
                      <div class="dv-card">
                        ...
                        <div class="dv-stat__row">
                          ...
                          <svg class="dv-spark" viewBox="0 0 40 14" preserveAspectRatio="none" aria-hidden="true">
                            <polyline points="1,11 8,8 15,10 22,5 29,7 38,2" fill="none" stroke="rgb(184,235,0)"
                              stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></polyline>
                          </svg>
                        </div>
                      </div>
                      <div class="dv-card">
                        ...
                        <div class="dv-stat__row">
                          ...
                          <svg class="dv-spark" viewBox="0 0 40 14" preserveAspectRatio="none" aria-hidden="true">
                            <polyline points="1,9 8,11 15,6 22,8 29,4 38,3" fill="none" stroke="rgb(184,235,0)"
                              stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></polyline>
                          </svg>
                        </div>
                      </div>
                      <div class="dv-card">
                        ...
                        <div class="dv-stat__row">
                          ...
                          <svg class="dv-spark" viewBox="0 0 40 14" preserveAspectRatio="none" aria-hidden="true">
                            <polyline points="1,10 8,7 15,9 22,6 29,7 38,4" fill="none" stroke="rgb(184,235,0)"
                              stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></polyline>
                          </svg>
                        </div>
                      </div>
                    ...
                    <div class="dv-ui__row">
                      ...
                      <div class="dv-card">
                        ...
                        <svg class="dv-chart" viewBox="0 0 260 66" preserveAspectRatio="none" aria-hidden="true">
                          ...
                          <path d="M4,50 L40,37 L76,44 L112,21 L148,30 L184,12 L220,24 L256,7 L256,66 L4,66 Z"
                            fill="url(#dvFill)"></path>
                          <polyline points="4,50 40,37 76,44 112,21 148,30 184,12 220,24 256,7" fill="none"
                            stroke="rgb(184,235,0)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                          </polyline>
  ...
  <div class="container">
    <div class="d-flex gap-4 mb-5 pb-4 justify-content-center align-items-center">
      ...
      <div class="heading-section mb-0 text-center">
        <span class="heading-subtitle mb-0 flex-wrap justify-content-center rounded-pill wow fadeInUp"
          data-wow-delay=".3s">
          Partnering with
    ...
    <div class="swiper client-swiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="{{ asset('FrontendAssets/images/png/apps/6.svg')}}" alt="Brand" class="brand02-image rounded"
            style="padding: 0rem;" loading="lazy" decoding="async">
        </div>
        <div class="swiper-slide">
          <img src="{{ asset('FrontendAssets/images/png/apps/7.svg')}}" alt="Brand" class="brand02-image rounded"
            style="padding: 0rem;" loading="lazy" decoding="async">
        </div>
        <div class="swiper-slide">
        ...
        <div class="swiper-slide">
          <img src="{{ asset('FrontendAssets/images/png/apps/10.svg')}}" alt="Brand" class="brand02-image rounded"
            style="padding: 0rem;" loading="lazy" decoding="async">
        </div>
        <div class="swiper-slide">
    ...
    <div class="row gy-4 gx-5 align-items-center about-container">
      ...
      <div class="col-lg-5 position-relative d-lg-block d-none">
        <div class="abt-media clip-anim">
          <img loading="lazy" class="abt-media__main anim-img" data-animate="true"
            src="{{ asset('FrontendAssets/images/shapes/6.png')}}" alt="about">
        </div>
        <div class="abt-media__svg">
          <img src="{{ asset('FrontendAssets/images/shapes/5.png')}}" alt="" class="img-fluid" loading="lazy"
            decoding="async">
        </div>
      </div>
      <!-- Right content -->
        ...
        <div class="abt-copy abt-copy--v2">
          <div class="heading-section text-start">
            <span class="heading-subtitle rounded-pill wow fadeInUp" data-wow-delay=".3s">
              <svg fill="var(--primary-color)" width="18" height="22" viewBox="0 0 32 32"
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M20.093 18.177c0 2.26-1.833 4.093-4.093 4.093s-4.093-1.833-4.093-4.093c0-5.459 8.187-5.459 8.187 0zM16 2.473c7.145 0.057 15.271 5.095 16 14.589h-9.677c0 0-1.244-5.245-6.323-5.208-5.079 0.031-6.323 5.208-6.323 5.208h-9.677c0.469-9.328 8.459-14.647 16-14.589zM16.068 29.527c-5.328 0.015-10.308-4.005-12.349-10.235h5.959c0 0 1.281 5.187 6.359 5.151 5.084-0.031 6.292-5.151 6.292-5.151h5.953c-1.328 6.588-6.885 10.219-12.213 10.235z" />
              </svg>
          ...
          <div class="abt-split">
            ...
            <div>
              <div class="d-flex gap-3 flex-wrap mb-4">
                <div class="avatar-list-stacked me-3">
                  <span class="avatar avatar-rounded">
                    <img src="{{ asset('FrontendAssets/images/profile/1.jpg')}}" alt="img" loading="lazy"
                      decoding="async">
                  </span>
                  <span class="avatar avatar-rounded">
                    <img src="{{ asset('FrontendAssets/images/profile/2.jpg')}}" alt="img" loading="lazy"
                      decoding="async">
                  </span>
                  <span class="avatar avatar-rounded">
                    <img src="{{ asset('FrontendAssets/images/profile/3.jpg')}}" alt="img" loading="lazy"
                      decoding="async">
                  </span>
                  <span class="avatar avatar-rounded">
                    <img src="{{ asset('FrontendAssets/images/profile/4.jpg')}}" alt="img" loading="lazy"
                      decoding="async">
                  </span>
                </div>
                <div>
              ...
              <p class="abt-split__text  op-7">
                We’re Deveon Inc, a software development company that turns your ideas into scalable digital products —
                from custom software and mobile apps to websites, AI/ML integrations, and design that leave a lasting
                impact.
              </p>
            </div>
          </div>
    ...
    <div class="row gy-4 mb-0">
      <div class="col-sm-6 col-lg-4">
        <div class="services-card wow fadeInUp" data-wow-delay=".1s" style="--accent:#f2a90c;">
          ...
          <p class="services-card__desc">
            Custom business software and portal solutions designed for scalability and reliability, built around the way
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="services-card wow fadeInUp" data-wow-delay=".2s" style="--accent:#3b6fe0;">
          ...
          <p class="services-card__desc">
            Deliver seamless and enjoyable digital experiences. Our designs prioritize clarity, ease of use, and
            attractive interfaces for both web and mobile platforms.
          </p>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="services-card wow fadeInUp" data-wow-delay=".3s" style="--accent:#1f9d63;">
          ...
          <p class="services-card__desc">
            Native and cross-platform app experiences with smooth performance and clean UX. We turn ideas into
            high-performing mobile apps tailored to your users' needs.
          </p>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="services-card wow fadeInUp" data-wow-delay=".1s" style="--accent:#17a2a6;">
          ...
          <p class="services-card__desc">
            Modern, responsive, and conversion-focused websites tailored to your business goals — from marketing sites
            to complex web platforms and e-commerce stores.
          </p>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="services-card wow fadeInUp" data-wow-delay=".2s" style="--accent:#d1483f;">
          ...
          <p class="services-card__desc">
            Search visibility, content strategy, and growth campaigns that drive quality traffic and turn visitors into
            customers.
          </p>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="services-card wow fadeInUp" data-wow-delay=".3s" style="--accent:#7b4fd1;">
          ...
          <p class="services-card__desc">
            We build intelligent features — from automation and predictive models to AI-powered integrations — that give
            your product a competitive edge.
          </p>
          ...
          <div class="choose04-us-section__features mb-0 row gy-4 gx-5 align-items-end">
            ...
            <div class="col-md-5">
              <div class="choose4-us-image">
                <img src="{{ asset('FrontendAssets/images/shapes/5.png')}}" alt="img"
                  class="arrow-img d-lg-block d-none" loading="lazy" decoding="async">
  ...
  <div class="swiper chooseus-marque marquee-section">
    <div class="swiper-wrapper marquee-container">
      <div class="swiper-slide marquee-item">
        ...
        <img class="marquee-icon" src="{{ asset('FrontendAssets/images/shapes/4.svg')}}" alt="" loading="lazy"
          decoding="async">
      </div>
      <div class="swiper-slide marquee-item">
  ...
  <div class="container">
    ...
    <div class="swiper portpolio04-swiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <article class="portfolio-card wow fadeInUp" data-wow-delay=".{{ $loop->iteration }}s" data-tilt
            ...
            <div class="portfolio-card__info">
              ...
              <a class="portfolio-card__link" href="{{ route('portfolio.detail', $item['slug']) }}">View Project <i
  ...
  <div class="container">
    ...
    <div class="process-dark-header">
      ...
      <p class="process-dark-desc wow fadeInUp" data-wow-delay=".3s">
        From initial concept to final launch, we follow a proven process that ensures smart solutions, measurable
    ...
    <div class="process-dark-steps">
      <div class="process-dark-step wow fadeInUp" data-wow-delay=".1s">
        ...
        <p class="process-dark-step__text">We analyze your goals, market, and challenges to craft the right IT strategy
          and roadmap.</p>
      </div>
      ...
      <div class="process-dark-step wow fadeInUp" data-wow-delay=".2s">
        ...
        <p class="process-dark-step__text">Our architects design scalable, secure, and user-focused systems tailored to
      ...
      <div class="process-dark-step wow fadeInUp" data-wow-delay=".3s">
        ...
        <p class="process-dark-step__text">We perform rigorous testing to ensure performance, security, and reliability
      ...
      <div class="process-dark-step wow fadeInUp" data-wow-delay=".4s">
        ...
        <p class="process-dark-step__text">We deploy with precision and support your growth through continuous
          optimization and innovation.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section home-blog-section">
  <div class="container">
    <div class="row section-header-cta align-items-end gy-4 mb-5">
      ...
      <div class="col-lg-6">
        <p>
          At Deveon Inc, we share insights on software development, mobile apps, design, and digital growth to help
          businesses build smarter products.
        </p>

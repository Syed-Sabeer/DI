<style>
  ...
  .footer-career-badge {
    ...
    line-height: 1;
    letter-spacing: .01em;
    box-shadow: 0 5px 14px rgba(103, 70, 245, .28);
    white-space: nowrap
  }
</style>
<!-- Start::footer -->
  ...
  <div class="container">
    <div class="footer-inner">
      ...
      <div class="footer-column footer-about">
        ...
        <div class="footer-social">
          ...
          <ul class="social-links">
            <li>
              <a href="{{ config('seo.social.facebook') }}" target="_blank" rel="noopener noreferrer"
                aria-label="Deveon Inc on Facebook" class="social-link">
                <i class="ri-facebook-circle-fill">
                </i>
              </a>
            </li>
            <li>
              <a href="{{ config('seo.social.instagram') }}" target="_blank" rel="noopener noreferrer"
                aria-label="Deveon Inc on Instagram" class="social-link">
                <i class="ri-instagram-fill">
                </i>
              </a>
            </li>
            <li>
              <a href="{{ config('seo.social.x') }}" target="_blank" rel="noopener noreferrer"
                aria-label="Deveon Inc on X (Twitter)" class="social-link">
                <i class="ri-twitter-x-line">
                </i>
              </a>
            </li>
            <li>
              <a href="{{ config('seo.social.linkedin') }}" target="_blank" rel="noopener noreferrer"
                aria-label="Deveon Inc on LinkedIn" class="social-link">
        ...
        <ul class="menu-list">
          ...
          <li>
            <a href="{{ route('careers') }}" class="footer-career-link">
              ...
              <span class="footer-career-badge">{{ $activeCareerCount }} {{ \Illuminate\Support\Str::plural('job',
                $activeCareerCount) }}</span>
              @endif
            </a>
          </li>
          <li>
      ...
      <div class="footer-column footer-newsletter mb-0">
        ...
        <form class="newsletter-form mb-5" id="footer-newsletter-form" method="POST"
          action="{{ route('newsletter.subscribe') }}" novalidate>
          @csrf
          <label class="visually-hidden" for="footer-newsletter-email">Email address</label>
          <input type="email" name="email" id="footer-newsletter-email" class="newsletter-input"
...
<!-- End::footer -->
<style>
  #footer-newsletter-form .newsletter-btn:disabled {
    cursor: wait;
    opacity: .72;
  }

  #footer-newsletter-form .newsletter-spinner {
    animation: newsletter-spin .75s linear infinite;
  }

  #footer-newsletter-form .newsletter-input.is-invalid {
    border-color: #ff5b5b !important;
    box-shadow: 0 0 0 3px rgba(255, 91, 91, .12);
  }

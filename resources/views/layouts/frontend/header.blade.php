      ...
      <div class="ms-4 me-3 brand-header-container">
        <div>
          ...
          <a href="{{ route('home') }}" class="brand-main">
            <img src="{{ asset('FrontendAssets/images/brand/logo-white.png')}}" alt="Deveon Inc"
              class="desktop-logo logo-white">
            <img src="{{ asset('FrontendAssets/images/brand/logo-dark.png')}}" alt="Deveon Inc"
              class="desktop-logo logo-dark" decoding="async">
            <img src="{{ asset('FrontendAssets/images/brand/logo-light.png')}}" alt="Deveon Inc"
              class="desktop-logo logo-light" decoding="async">
            <img src="{{ asset('FrontendAssets/images/brand/toggle-dark.png')}}" alt="Deveon Inc"
              class="mobile-logo mobile-dark" decoding="async">
            <img src="{{ asset('FrontendAssets/images/brand/logo-color.png')}}" alt="Deveon Inc"
              class="desktop-logo logo-color" decoding="async">
            <img src="{{ asset('FrontendAssets/images/brand/toggle-color.png')}}" alt="Deveon Inc"
              class="mobile-logo mobile-color" decoding="async">
          </a>
        </div>
        <!-- Start::header-element -->
        <div class="d-flex align-items-center gap-1">
          <button type="button" class="header-theme-toggle header-link" aria-label="Switch to dark mode"
          ...
          <div class="header-element me-1">
            <!-- Start::header-link -->
            <a aria-label="anchor" href="javascript:void(0);" class="sidemenu-toggle1 header-link"
          ...
          <div class="main-brand-header">
            <div class="container brand-header-container d-none d-lg-flex">
              <div class="d-flex align-items-center">
                ...
                <a href="{{ route('home') }}" class="brand-main">
                  <img src="{{ asset('FrontendAssets/images/brand/logo-white.png')}}" alt="Deveon Inc"
                    class="desktop-logo logo-white" decoding="async">
                  <img src="{{ asset('FrontendAssets/images/brand/logo-dark.png')}}" alt="Deveon Inc"
                    class="desktop-logo logo-dark" decoding="async">
                  <img src="{{ asset('FrontendAssets/images/brand/logo-light.png')}}" alt="Deveon Inc"
                    class="desktop-logo logo-light" decoding="async">

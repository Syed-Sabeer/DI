...
<div class="offcanvas offcanvas-end" tabindex="-1" id="switcher-canvas">
  <div class="offcanvas-header justify-content-between border-bottom-0">
    ...
    <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon custom-canvas-close"
      ...
      <div class="row switcher-style">
        <div class="col-5">
          <div class="form-check switch-select">
            ...
            <input class="form-check-input form-checked-dark" type="radio" name="theme-style" id="switcher-light-theme"
              checked>
          </div>
        </div>
        <div class="col-5">
      ...
      <div class="row switcher-style">
        <div class="col-6 col-xl-5">
          <div class="form-check switch-select">
            ...
            <input class="form-check-input form-checked-dark" type="radio" name="layout-width" id="switcher-full-width"
              checked>
          </div>
        </div>
        <div class="col-6 col-xl-5">
      ...
      <div class="row switcher-style gx-0">
        <div class="col-4">
          <div class="form-check switch-select">
            ...
            <input class="form-check-input form-checked-dark" type="radio" name="page-loader"
...
<div class="">
  ...
  <!-- Start Switcher-Icon -->
  {{-- <a aria-label="anchor" class="switcher-icon" data-bs-toggle="offcanvas" href="#switcher-canvas"
    aria-controls="switcher-canvas">
